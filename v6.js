...
(()=>{
'use strict';
const VERSION='6.4.118-tier3-study-arcade', SNAPSHOT_PREFIX='jm_v6_snapshots_', FEEDBACK_INBOX_KEY='jm_v6_admin_feedback_inbox', FEEDBACK_INBOX_LIMIT=200;
...
function manageCompanionDisplay(){
 const info=companionDisplayInfo();if(!info.available){state.v6.showFloatingCompanion=true;save();syncCompanionDisplayButton();openShop?.('companions');return;}
...
function syncInstallAppControl(){
 ...
 button.title=installed?'Language Miner is already installed':appleMobile?'Add Language Miner to the iPhone or iPad Home Screen':ready?'Install Language Miner on this device':'Installation is not currently available in this browser';
...
function openPatreon(){ensureV6();openOverlay('feedback');const dialog=document.getElementById('v6FeedbackOverlay'),box=document.getElementById('v6FeedbackContent');if(dialog){const kicker=dialog.querySelector('.menu-header-copy span'),title=dialog.querySelector('.menu-header-copy h2');if(kicker)kicker.textContent='Language Miner Support';if(title)title.textContent='â­ Patreon Tiers';}if(box)box.innerHTML=`<section class="supporter-tier-list"><article class="supporter-tier tier-one"><img src="patreon-tier-1-supporter.png" alt="Supporter tier cover: $1 per month"><span>ðŸŸ© TIER 1 Â· SUPPORTER Â· $1 / MONTH</span><h3>Cosmetics and community</h3><p>Clothing, hats, accessories, pickaxe skins, character titles, wallpapers, Discord role, behind-the-scenes posts, development updates, poll voting, and optional Supporter credits.</p></article><article class="supporter-tier tier-two"><img src="patreon-tier-2-companion-keeper.png" alt="Companion Keeper tier cover: $3 per month"><span>ðŸŸ¦ TIER 2 Â· COMPANION KEEPER Â· $3 / MONTH</span><h3>Everything in Tier 1, plus companions</h3><p>Companion system, companion cosmetics, companion names, companion idle animations, and the exclusive companion collection.</p></article><article class="supporter-tier tier-three"><img src="patreon-tier-3-settlement-founder.png" alt="Settlement Founder tier cover: $5 per month"><span>ðŸŸ¨ TIER 3 Â· SETTLEMENT FOUNDER Â· $5 / MONTH</span><h3>Everything above, plus settlements</h3><p>Settlement system, decorations, exclusive buildings, seasonal decorations, and settlement customization.</p></article><p class="supporter-link-note">Membership linking requires administrator setup. Until configured, locked sections show the required tier.</p></section>`;}
const originalOpenPatreon=openPatreon;openPatreon=function(){originalOpenPatreon();const tierOneDescription=document.querySelector('#v6FeedbackContent .supporter-tier.tier-one p'),tierThreeDescription=document.querySelector('#v6FeedbackContent .supporter-tier.tier-three p');if(tierOneDescription)tierOneDescription.textContent='Clothing, hats, accessories, rock skins, mine wallpapers, pickaxe skins, full-page wallpapers, character titles, Discord role, behind-the-scenes posts, development updates, poll voting, and optional Supporter credits.';if(tierThreeDescription)tierThreeDescription.textContent='Settlement system, decorations, exclusive buildings, seasonal decorations, settlement customization, and the complete Study Arcade with Memory Mine, Crystal Match, and Star Word Defender.';document.getElementById('v6FeedbackContent')?.insertAdjacentHTML('beforeend','<a class="supporter-join-link" href="https://www.patreon.com/cw/Erendragneel/membership" target="_blank" rel="noopener">Join Language Miner on Patreon</a>');window.renderJapaneseMinerPatreonLinking?.(document.getElementById('v6FeedbackContent'));};
...
window.openJapaneseMinerGuide=openTour;window.openJapaneseMinerSettings=openSettings;window.openJapaneseMinerFeedback=openFeedback;window.openLanguageMinerShare=openShareGame;window.languageMinerShareUrl=shareGameUrl;
